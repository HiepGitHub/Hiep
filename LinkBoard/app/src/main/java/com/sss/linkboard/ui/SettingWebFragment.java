...
public class SettingWebFragment extends BaseFragment {
    public static SettingWebFragment createInstance(Bundle bundle) {
    ...
    public interface SettingWebFragmentDelegate {

    }

    private SettingWebFragmentDelegate delegate;
    ...
    public void onAttach(Activity activity) {
        ...
        delegate = (SettingWebFragmentDelegate) activity;
    }
    ...
    class ContentPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View view = getActivity().getLayoutInflater().inflate(R.layout.widget_web_setting_search_terms,
                    container, false);
            ...
            if (position == defaultIndex) {
                SettingWebSearchModel model = SettingWebSearchModel.getInstance(getActivity());
                edAll.setText(model.getBingAll());
                edAny.setText(model.getBingAny());
                edNone.setText(model.getBingNon());
                edExact.setText(model.getBingExact());
            }
            ...
            buttonSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    SettingWebSearchModel.getInstance(getActivity()).saveToLocal(all, any, exact, none);
